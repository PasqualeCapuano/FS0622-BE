package it.pasqualecapuano.app;
...
import it.pasqualecapuano.app.config.EdificioConfig;
import it.pasqualecapuano.app.config.PostazioneConfig;
import it.pasqualecapuano.app.config.PrenotazioneConfig;
import it.pasqualecapuano.app.config.UtenteConfig;
import it.pasqualecapuano.app.dao.EdificioService;
import it.pasqualecapuano.app.dao.PostazioneService;
import it.pasqualecapuano.app.dao.PrenotazioneService;
import it.pasqualecapuano.app.dao.UtenteService;
...
public class GestionePrenotazioniApplication implements CommandLineRunner {
	...
	public void gestore() {
		try {
			System.out.println("Benvenuto nel pannello prenotazioni");
			System.out.println("-------------------------------------");
