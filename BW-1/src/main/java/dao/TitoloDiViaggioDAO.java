...
public class TitoloDiViaggioDAO extends JpaUtils {
	...
	//ritorna il numero totale di biglietti o abbonamenti emessi in un determinato periodo
	...
	//controllare la vidimazione di un biglietto o la scadenza di un abbonamento e permette all'utente di salire o no su un mezzo
	...
	//modifica la validità di un abbonamento a FALSE quando è scaduto (la query si trova in ABBONAMENTO)
