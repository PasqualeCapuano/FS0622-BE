...
public class Menu extends JpaUtils {
	...
	//funzione per acquistare una tessera
	...
	//seleziona il mezzo per viaggiare
	...
	//metodo per creare l'abbonamento e controlla se l'abbonamento esiste o no
	...
	//metodo per creare un distributore
	...
	//metodo per creare un rivenditore
	...
	//metodo per stampare i dati della tessera
	...
	//metodo per rinnovare la tessera
